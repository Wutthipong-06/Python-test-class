def format_string(text, format_type="upper"):  # สร้างฟังก์ชันชื่อ format_string รับพารามิเตอร์ text และ format_type (ค่าเริ่มต้น "upper")
    """
    Dynamic string formatter ที่สามารถจัดรูปแบบข้อความได้หลายแบบ
    
    Args:
        text (str): ข้อความที่ต้องการจัดรูปแบบ
        format_type (str): ประเภทการจัดรูปแบบ
            - "upper": แปลงเป็นตัวพิมพ์ใหญ่
            - "lower": แปลงเป็นตัวพิมพ์เล็ก
            - "remove_spaces": ลบช่องว่างทั้งหมด
            - "hyphenate": แทนที่ช่องว่างด้วยขีดกลาง (-)
    
    Returns:
        str: ข้อความที่ผ่านการจัดรูปแบบแล้ว
    """
...
def main():  # สร้างฟังก์ชันหลักชื่อ main
    """ฟังก์ชันหลักสำหรับทดสอบการทำงานของ formatter"""
    ...
    print("=== Dynamic String Formatter Results ===")  # แสดงหัวข้อของผลลัพธ์
